	...
	public Delete(){
		...
		n.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				...
				File file_d = new File("F:\\新建文件夹\\" + name + ".txt");
		...
		p.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				...
				int flag = 1;
				while(flag == 1){
					File file_p = new File("F:\\新建文件夹\\" + name + ".txt");
					if(file_p.exists()){
						flag = 0;
					}
					else {
						...
						i++;
						j = String.valueOf(i);
						File file_p1 = new File("F:\\新建文件夹\\" + j + ".txt");
						File file_p2 = new File("F:\\新建文件夹\\" + name + ".txt");
						...
						l++;
						m = String.valueOf(l);
						File file_p3 = new File("F:\\新建文件夹\\" + m + ".txt");
						if (file_p3.exists()){  
							flag = 1;
						}
						else {
